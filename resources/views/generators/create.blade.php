	...
	<script>
		...
		$('.js-testslack').on('click',function(){
			if($(this).hasClass('is-active')){
				...
				$.get("/api/generators/actions/testslack/"+$('.js-slackservices').val()+"/"+$('.js-channel').val(), function(data){ console.log(data); });
		...
		function getProfiles(service,account,property){
			$.get("/api/generators/actions/getprofiles/"+service+"/"+account+"/"+property, function(data) {
				var html = "";
		...
		function getProperties(service,account){
			$.get("/api/generators/actions/getproperties/"+service+"/"+account, function(data) {
				var html = "";
		...
		function getAccounts(service){
			$.get("/api/generators/actions/getaccounts/"+service, function(data) {
				var html = "";
				for(var i in data){ html += "<a href='#' class='list-group-item' data-value='"+data[i].id+"'>"+data[i].name+"</a>"; }
		...
		function getServices(){
			...
			$.get("/api/generators/actions/getservices", function(data) {
				var htmlAnalytics = "";
				var htmlSlack = "";
				for(var i in data){ 
					if(data[i].slug == "ga"){
